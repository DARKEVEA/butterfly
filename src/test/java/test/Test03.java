...
public class Test03 extends PApplet {
    ...
    public class  Neuron{
        ...
        void makeSynapse(){
            ...
            for(int i = 0;i<n.length;i++){
                if(i!=id && dist(x,y,n[i].x,n[i].y)<=radius&&noise(i/100.0f)<0.8){
        ...
        void drawSynapse(){
            ...
            int c2 = color(255,204,17);
            stroke(lerpColor(c2,c1,norm(val,0,255)),4);
        ...
        void move(){
            x+=(noise(id+frameCount/10.0f)-.5);
            y+=(noise(id*5+frameCount/10.0f)-.5);
        }
